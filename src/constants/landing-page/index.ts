...
export const CATEGORIES = ["All", "Design", "Marketing", "Copywriting", "Dev", "Productivity"] as const;
...
export const PROMPTS: Prompt[] = [
  { id: 1, title: "Ultra-Realistic Midjourney Studio Product Photography", category: "Design", author: "Mira Chen", authorInitials: "MC", rating: 5, uses: "12.4k", tag: "Trending", emoji: "📸", color: "#FF6B35" },
  { id: 2, title: "Automated Figma to Code Design Token Generator", category: "Design", author: "Noah Park", authorInitials: "NP", rating: 4, uses: "6.7k", tag: "New", emoji: "🎨", color: "#F59E0B" },
  { id: 3, title: "B2B Cold Email Sequence That Consistently Books Meetings", category: "Marketing", author: "Jake Wolfe", authorInitials: "JW", rating: 5, uses: "9.1k", tag: "Best Seller", emoji: "📧", color: "#7C3AED" },
  { id: 4, title: "Viral Twitter/X Thread & Hook Architect (10x Impressions)", category: "Marketing", author: "Lena Brooks", authorInitials: "LB", rating: 5, uses: "18.6k", tag: "Viral", emoji: "🧵", color: "#F59E0B" },
  { id: 5, title: "High-Converting SaaS Landing Page Copywriter Engine", category: "Copywriting", author: "Priya S.", authorInitials: "PS", rating: 5, uses: "7.8k", tag: "Hot", emoji: "✍️", color: "#0EA5E9" },
  { id: 6, title: "SEO E-Commerce Product Description Generator", category: "Copywriting", author: "Ellie Ross", authorInitials: "ER", rating: 4, uses: "5.9k", tag: "Popular", emoji: "🛍️", color: "#EC4899" },
  { id: 7, title: "Senior Full-Stack Code Reviewer & Refactor Specialist", category: "Dev", author: "Tom Nakamura", authorInitials: "TN", rating: 5, uses: "22.3k", tag: "Top Rated", emoji: "🛠️", color: "#10B981" },
  { id: 8, title: "OpenAPI Spec to REST API Documentation Generator", category: "Dev", author: "Sam Osei", authorInitials: "SO", rating: 5, uses: "8.3k", tag: "Trending", emoji: "📄", color: "#0EA5E9" },
  { id: 9, title: "Executive Business Intelligence & Strategy Report Writer", category: "Productivity", author: "Arjun Mehta", authorInitials: "AM", rating: 4, uses: "5.2k", tag: "New", emoji: "📊", color: "#EC4899" },
  { id: 10, title: "Raw Zoom Meeting Transcript to Exec Action Items", category: "Productivity", author: "Zara Ahmed", authorInitials: "ZA", rating: 5, uses: "11.0k", tag: "Popular", emoji: "✅", color: "#10B981" },
];